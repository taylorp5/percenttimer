...
class PercentTimeMediumWidgetProvider : AppWidgetProvider() {
  ...
  companion object {
    fun updateWidget(context: Context, appWidgetManager: AppWidgetManager, widgetId: Int) {
      WidgetRenderer.updateWidget(context, appWidgetManager, widgetId, com.percenttime.R.layout.percenttime_widget_medium)
    }

    fun updateAllWidgets(context: Context, appWidgetManager: AppWidgetManager = AppWidgetManager.getInstance(context)) {
      val ids = appWidgetManager.getAppWidgetIds(ComponentName(context, PercentTimeMediumWidgetProvider::class.java))
