...
class PercentTimeSmallWidgetProvider : AppWidgetProvider() {
  ...
  companion object {
    fun updateWidget(context: Context, appWidgetManager: AppWidgetManager, widgetId: Int) {
      WidgetRenderer.updateWidget(context, appWidgetManager, widgetId, com.percenttime.R.layout.percenttime_widget_small)
    }

    fun updateAllWidgets(context: Context, appWidgetManager: AppWidgetManager = AppWidgetManager.getInstance(context)) {
      val ids = appWidgetManager.getAppWidgetIds(ComponentName(context, PercentTimeSmallWidgetProvider::class.java))
